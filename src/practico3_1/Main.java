...
class Main {
    ...
    public static void carpetas() {
        ...
        Vista.txtdos.append(" \n Carpeta del usuario = " + sCarpAct);
        //Lista con carpetas
        System.out.println(ANSI_RED + "//// LISTADO SIMPLE" + ANSI_RESET);
        Vista.txtdos.append(ANSI_RED + "\n ....::::::LISTADO SIMPLE::::::..... \n" + ANSI_RESET);

        File carpeta = new File(sCarpAct);
        String[] listado = carpeta.list();
        if (listado == null || listado.length == 0) {
            System.out.println("No hay elementos dentro de la carpeta actual");
            Vista.txtdos.append("No hay elementos dentro de la carpeta actual");
            return;
        } else {
            for (int i = 0; i < listado.length; i++) {
                System.out.println(listado[i]);
                Vista.txtdos.append(listado[i]);
            }
        }

        //Propiedades de cada archivo
        System.out.println(ANSI_RED + "//// LISTADO CON OBJETOS File" + ANSI_RESET);
        Vista.txttres.append(ANSI_RED + "\n .....:::::: LISTADO CON OBJETOS File:::::::::......" + ANSI_RESET);

        File[] archivos = carpeta.listFiles();
        if (archivos == null || archivos.length == 0) {
            System.out.println("No hay elementos dentro de la carpeta actual");
            Vista.txttres.append("\n .......::::::::No hay elementos dentro de la carpeta actual::::::::::..........");
            return;
        } else {
            ...
            for (int i = 0; i < archivos.length; i++) {
                ...
                Vista.txttres.append(String.format("\n %s (%s) - %d - %s",
                        archivo.getName(),
                        archivo.isDirectory() ? "Carpeta" : "Archivo",
                        archivo.length(),
                        sdf.format(archivo.lastModified())
        ...
        Vista.txttres.append(ANSI_RED + " \n .........:::::::: LISTADO CON FILTRO APLICADO - SOLO ARCHIVOS::::::::......" + ANSI_RESET);
        ...
        if (archivos == null || archivos.length == 0) {
            ...
            for (int i = 0; i < archivos.length; i++) {
                ...
                Vista.txtdos.append(String.format(" \n %s (%s) - %d - %s",
                        archivo.getName(),
                        archivo.isDirectory() ? "Carpeta" : "Archivo",
                        archivo.length(),
                        sdf.format(archivo.lastModified())
